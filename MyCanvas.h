...
private:
   ...
   GPixel ConvertColor(const GColor& color) const;
   GPixel blendPixel(GPixel dstPixel, GPixel srcPixel, GBlendMode blendMode) const;
   void computeBC(int x, int y, const GPoint& p0, const GPoint& p1, const GPoint& p2, float& alpha, float& beta, float& gamma);
